...
export function MainMenu() {
  ...
  return <main className="main-menu">
    ...
    <div className="menu-content">
      <section className="hero-copy"><div className="eyebrow hero-eyebrow"><span/> NOT JUST A GAME. A FEELING.</div><h1>FEEL EVERY<br/><em>CONTACT.</em><span className="title-period">®</span></h1><p className="hero-description">The anticipation. The movement. The perfect connection.<br/>Badminton, from where you’re meant to play.</p><div className="hero-action"><button className="primary-button" onClick={() => setPanel('setup')}>{mode === 'match' ? 'Let’s play' : mode === 'practice' ? 'Find your rhythm' : 'Sharpen your game'}<ArrowUpRight size={24}/></button><span className="perspective-label"><span className="tiny-viewfinder"/>A FIRST-PERSON EXPERIENCE</span></div></section>
