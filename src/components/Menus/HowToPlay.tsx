...
export function HowToPlay({ onClose }: { onClose: () => void }) {
  ...
  return <Modal title="Find your sweet spot." eyebrow="THE ESSENTIALS" onClose={onClose} wide>
    ...
    <div className="guide-tip"><Footprints size={21}/><p><strong>Start with free practice.</strong> Choose Assisted + Casual. Learn contact in practice, then mix right-click drops and F smashes in a match. Different placements create different replies. Switch to Simulation in Settings only when you want exact-contact control.</p></div>
