...
export function HowToPlay({ onClose }: { onClose: () => void }) {
  return <Modal title="Find your sweet spot." eyebrow="THE ESSENTIALS" onClose={onClose} wide>
    <p className="modal-intro">Not a button for every shot. Just you, your racket, and the shuttle.</p>
    <div className="guide-grid">
      ...
      <article><Crosshair size={23}/><span>03 / MAKE CONTACT</span><h3>Your mouse is your swing.</h3><p>Hold the left mouse button and move your mouse to guide your racket. Up raises it, down lowers it; both extend your reach. A quicker motion transfers more speed. Release to recover.</p></article>
      <article><ScanLine size={23}/><span>04 / START A RALLY</span><h3>Serve. Read. Recover.</h3><p>Press <kbd>E</kbd> to release your serve, then swing through the shuttle. Contact below 1.15 m into the diagonal service box. Practice and training feed automatically; <kbd>E</kbd> restarts a feed. In training, use the requested shot and land in the highlighted zone. <kbd>Esc</kbd> pauses.</p></article>
    </div>
    <div className="guide-tip"><Footprints size={21}/><p><strong>Start with free practice.</strong> Turn on the shuttle trail and landing marker. Learn the reach of your racket before chasing power.</p></div>
