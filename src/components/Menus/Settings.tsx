...
export function Settings({ onClose }: { onClose: () => void }) {
  ...
  return <Modal title="Make it your game." eyebrow="PREFERENCES" onClose={onClose}>
    ...
    <button className="text-button" onClick={() => set({ volume: 0.55, sensitivity: 1, quality: 'balanced', trajectory: true, landing: true, impact: true, headMotion: true })}><RotateCcw size={14}/> Reset preferences</button>
  </Modal>;
}
